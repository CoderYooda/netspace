...
<head>
    ...
    <link rel="stylesheet" href="{{ mix('css/lending.css') }}" />
...
<main id="app">
    ...
    <div class="main-wrapper">
        ...
        <div class="cabinet-mobile">
            <a href="http://178.216.79.26/cabinet/" class="footer__cabinet footer__link" target="_blank" rel="noopener">
...
<script async src="{{ mix('js/lending.js') }}"></script>
